...
export function DataManagementPage() {
  ...
  const createMockPatients = (): Patient[] => {
    ...
    const entries = [
      {
        title: '',
        firstName: 'Ádám', lastName: 'Nagy', sex: 'male' as const,
        birthDate: '1988-02-17', birthPlace: 'Budapest',
        insuranceNum: '111-222-337',
        phone: '+36 30 123 4567', email: 'nagy.adam@example.com',
        country: 'Magyarország', zipCode: '1052', city: 'Budapest',
        street: 'Petőfi Sándor u. 3.', patientType: 'Privát páciens',
      },
      {
        title: 'Dr.',
        firstName: 'Gábor', lastName: 'Kovács', sex: 'male' as const,
        birthDate: '1979-11-03', birthPlace: 'Debrecen',
        insuranceNum: '234-567-898',
        phone: '+36 20 234 5678', email: 'kovacs.gabor@example.com',
        country: 'Magyarország', zipCode: '9700', city: 'Szombathely',
        street: 'Kossuth Lajos u. 12.', patientType: 'NEAK páciens',
      },
      {
        title: '',
        firstName: 'Márk', lastName: 'Tóth', sex: 'male' as const,
        birthDate: '1994-06-25', birthPlace: 'Győr',
      ...
      {
        title: '',
        firstName: 'Eszter', lastName: 'Szabó', sex: 'female' as const,
        birthDate: '1986-09-14', birthPlace: 'Pécs',
        insuranceNum: '456-789-018',
        phone: '+36 30 456 7890', email: 'szabo.eszter@example.com',
        country: 'Magyarország', zipCode: '6720', city: 'Szeged',
        street: 'Tisza Lajos krt. 67.', patientType: 'Privát páciens',
      },
      {
        title: '',
        firstName: 'Réka', lastName: 'Kiss', sex: 'female' as const,
        birthDate: '1991-04-09', birthPlace: 'Miskolc',
        insuranceNum: '567-890-128',
      ...
      {
        title: '',
        firstName: 'Lilla', lastName: 'Farkas', sex: 'female' as const,
        birthDate: '1983-12-01', birthPlace: 'Szombathely',
        insuranceNum: '678-901-238',
        phone: '+36 70 678 9012', email: 'farkas.lilla@example.com',
        country: 'Magyarország', zipCode: '8200', city: 'Veszprém',
        street: 'Óváros tér 4.', patientType: 'Privát páciens',
      },
    ];
